...
export DataKYandOnePion=/work/gothelab/clas12/software/genKYandOnePion/data
# Generate events
/work/gothelab/clas12/software/genKYandOnePion/eg_ky PiN $BEAM_E $Q2_MIN $Q2_MAX $W_MIN $W_MAX $NUM_EVENTS ${DATA_DIR}/lund/${NAME}.lund
